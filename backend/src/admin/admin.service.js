...
var AdminService = function () {
    ...
    var AdminService = _classThis = /** @class */ (function () {
        ...
        AdminService_1.prototype.addUser = function (data) {
        ...
        AdminService_1.prototype.removeUser = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.user.delete({ where: { id: userId } })];
                });
            });
        };
