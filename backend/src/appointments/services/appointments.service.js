...
var AppointmentsService = function () {
    ...
    var AppointmentsService = _classThis = /** @class */ (function () {
        ...
        AppointmentsService_1.prototype.bookSlot = function (createAppointmentDto) {
            return __awaiter(this, void 0, void 0, function () {
                var doctorId, patientId, slotId, slot, appointment;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            doctorId = createAppointmentDto.doctorId, patientId = createAppointmentDto.patientId, slotId = createAppointmentDto.slotId;
                            return [4 /*yield*/, this.prisma.availabilitySlot.findUnique({
                                    where: { id: slotId },
                                })];
                        case 1:
                            slot = _a.sent();
        ...
        AppointmentsService_1.prototype.updateStatus = function (id, updateStatusDto) {
            return __awaiter(this, void 0, void 0, function () {
                var status;
                return __generator(this, function (_a) {
                    status = updateStatusDto.status;
                    return [2 /*return*/, this.prisma.appointment.update({
                            where: { id: id },
                            data: { status: status },
                        })];
                });
