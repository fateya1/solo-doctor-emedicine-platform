...
var CreateAppointmentDto = function () {
    ...
    return _a = /** @class */ (function () {
            function CreateAppointmentDto() {
                ...
                this.patientId = (__runInitializers(this, _doctorId_extraInitializers), __runInitializers(this, _patientId_initializers, void 0));
                this.slotId = (__runInitializers(this, _patientId_extraInitializers), __runInitializers(this, _slotId_initializers, void 0));
                this.reason = (__runInitializers(this, _slotId_extraInitializers), __runInitializers(this, _reason_initializers, void 0));
        ...
        (function () {
            ...
            _doctorId_decorators = [(0, class_validator_1.IsUUID)()];
            _patientId_decorators = [(0, class_validator_1.IsUUID)()];
            _slotId_decorators = [(0, class_validator_1.IsUUID)()];
            _reason_decorators = [(0, class_validator_1.IsString)()];
            _status_decorators = [(0, class_validator_1.IsEnum)(client_1.AppointmentStatus)];
