...
var AuditController = function () {
    var _classDecorators = [(0, common_1.Controller)("audit"), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)("ADMIN")];
    ...
    var AuditController = _classThis = /** @class */ (function () {
        ...
        AuditController_1.prototype.getLogs = function (userId, action, startDate, endDate, page, limit) {
        ...
        AuditController_1.prototype.getStats = function () {
    ...
    (function () {
        ...
        _getLogs_decorators = [(0, common_1.Get)()];
