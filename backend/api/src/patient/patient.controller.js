...
var PatientController = function () {
    var _classDecorators = [(0, common_1.Controller)("patient"), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)("PATIENT")];
    ...
    var PatientController = _classThis = /** @class */ (function () {
        ...
        PatientController_1.prototype.getProfile = function (req) {
            return this.patientService.getProfile(req.user.sub);
        };
        PatientController_1.prototype.updateProfile = function (req, dto) {
