...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.login = function (dto, req) {
            var _a, _b, _c, _d;
            var ipAddress = (_c = (_b = (_a = req.headers["x-forwarded-for"]) === null || _a === void 0 ? void 0 : _a.split(",")[0]) !== null && _b !== void 0 ? _b : req.socket.remoteAddress) !== null && _c !== void 0 ? _c : "";
            var userAgent = (_d = req.headers["user-agent"]) !== null && _d !== void 0 ? _d : "";
    ...
    (function () {
        ...
        _register_decorators = [(0, common_1.Post)("register"), (0, swagger_1.ApiOperation)({ summary: "Register a new user" })];
        _login_decorators = [(0, common_1.Post)("login"), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, swagger_1.ApiOperation)({ summary: "Login and receive a JWT token" })];
        _forgotPassword_decorators = [(0, common_1.Post)("forgot-password"), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, swagger_1.ApiOperation)({ summary: "Request a password reset link via email" })];
        _resetPassword_decorators = [(0, common_1.Post)("reset-password"), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, swagger_1.ApiOperation)({ summary: "Reset password using the token from the email link" })];
