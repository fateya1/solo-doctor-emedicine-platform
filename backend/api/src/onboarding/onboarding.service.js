...
var OnboardingService = function () {
    ...
    var OnboardingService = _classThis = /** @class */ (function () {
        function OnboardingService_1(prisma) {
            this.prisma = prisma;
        }
        OnboardingService_1.prototype.getStatus = function (userId) {
        ...
        OnboardingService_1.prototype.saveProfile = function (userId, data) {
            return __awaiter(this, void 0, void 0, function () {
                var profile;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (!profile)
                                throw new common_1.NotFoundException("Doctor profile not found");
                            return [2 /*return*/, this.prisma.doctorProfile.update({
                                    where: { userId: userId },
                                    data: __assign(__assign({}, data), { onboardingStep: client_1.OnboardingStep.DOCUMENTS }),
                                })];
                    }
                });
            });
        };
        OnboardingService_1.prototype.saveDocuments = function (userId, data) {
            return __awaiter(this, void 0, void 0, function () {
                var profile;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, this.prisma.doctorProfile.update({
                                    ...
                                    data: {
                                        ...
                                        onboardingStep: client_1.OnboardingStep.PAYMENT,
                                    },
                                })];
                    }
                });
        ...
        OnboardingService_1.prototype.completePaymentStep = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                var profile;
                return __generator(this, function (_a) {
                    switch (_a.label) {
