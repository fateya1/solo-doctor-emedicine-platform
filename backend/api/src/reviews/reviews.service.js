...
var ReviewsService = function () {
    ...
    var ReviewsService = _classThis = /** @class */ (function () {
        ...
        ReviewsService_1.prototype.submitReview = function (userId, dto) {
                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            if (appointment.patientId !== patientProfile.id) {
                                throw new common_1.ForbiddenException("Not authorized to review this appointment");
                            }
                            if (appointment.status !== "COMPLETED") {
                                throw new common_1.BadRequestException("You can only review completed appointments");
                            }
                            if (appointment.review) {
                                throw new common_1.BadRequestException("You have already reviewed this appointment");
                            }
        ...
        ReviewsService_1.prototype.getDoctorReviews = function (doctorProfileId) {
            return __awaiter(this, void 0, void 0, function () {
                var reviews, avg;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.review.findMany({
        ...
        ReviewsService_1.prototype.getPatientReviewForAppointment = function (userId, appointmentId) {
            return __awaiter(this, void 0, void 0, function () {
                var patientProfile;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, this.prisma.review.findUnique({
