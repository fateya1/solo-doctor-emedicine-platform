...
var AvailabilityController = function () {
    ...
    var AvailabilityController = _classThis = /** @class */ (function () {
        ...
        AvailabilityController_1.prototype.listAvailable = function () {
            return this.service.listAvailableSlots();
        };
    ...
    (function () {
        ...
        _create_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Post)("slots")];
        _list_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Get)("slots")];
        _listAvailable_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Get)("slots/available")];
        _remove_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Delete)("slots/:id")];
        ...
        __esDecorate(_classThis, null, _listAvailable_decorators, { kind: "method", name: "listAvailable", static: false, private: false, access: { has: function (obj) { return "listAvailable" in obj; }, get: function (obj) { return obj.listAvailable; } }, metadata: _metadata }, null, _instanceExtraInitializers);
